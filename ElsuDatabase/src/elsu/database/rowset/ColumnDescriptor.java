...
public class ColumnDescriptor implements Serializable, Cloneable {
    ...
    public ColumnDescriptor(String jsonColumn) throws Exception {
    	ColumnDescriptor fd = null;
    	
        try {
        	fd = (ColumnDescriptor) JsonXMLUtils.JSon2Object(jsonColumn, ColumnDescriptor.class);
        } catch (Exception ex) {
    		throw new Exception (this.getClass().toString() + ".toString(), \n" + ex.getMessage() + "\n" + ex.getStackTrace());
        }
