 ...
 */
public class ASCIIByteBuilder {

    private byte[] _value;
    private int _count;
    private int _minGrowthSize = 64;

    public ASCIIByteBuilder(int capacity) {
        this._value = new byte[capacity];
    }

    public ASCIIByteBuilder(int capacity, int growthSize) {
        this._value = new byte[capacity];
    ...
    public ASCIIByteBuilder append(String str) {
        return append(str.getBytes());
    }

    public ASCIIByteBuilder append(Object obj) {
        return append(String.valueOf(obj));
    }

    public ASCIIByteBuilder append(StringBuffer sb) {
        if (sb == null) {
            return this;
        }
    ...
    public ASCIIByteBuilder append(CharSequence s, int start, int end) {
        if (s == null) {
            return this;
        }
    ...
    public ASCIIByteBuilder append(CharSequence s) {
        if (s == null) {
            return this;
        }
    ...
    public ASCIIByteBuilder append(char[] str) {
        return append(new String(str).getBytes());
    }

    public ASCIIByteBuilder append(byte[] bytes) {
    ...
    public ASCIIByteBuilder append(char[] str, int offset, int len) {
        return append(new String(str).getBytes(), offset, len);
    }

    public ASCIIByteBuilder append(byte[] bytes, int offset, int len) {
        int newCount = this._count + len;
        if (newCount > this._value.length) {
            expandCapacity(newCount);
        }
    ...
    public ASCIIByteBuilder append(byte b) {
    ...
    public ASCIIByteBuilder append(char c) {
        int newCount = this._count + 1;
        if (newCount > this._value.length) {
            expandCapacity(newCount);
        }
    ...
    public ASCIIByteBuilder append(int i) {
        return append(Integer.toString(i));
    }

    public ASCIIByteBuilder append(long l) {
        return append(Long.toString(l));
    }

    public ASCIIByteBuilder append(float f) {
        return append(Float.toString(f));
    }

    public ASCIIByteBuilder append(double d) {
        return append(Double.toString(d));
    }

    public ASCIIByteBuilder delete(char c) {
        return delete((byte) c);
    }

    // to-do
    public ASCIIByteBuilder delete(byte b) {
        return null;
    }

    // to-do
    public ASCIIByteBuilder delete(String str) {
        return null;
    }

    public ASCIIByteBuilder delete(int start, int end) {
        if (start < 0) {
    ...
    public ASCIIByteBuilder deleteByteAt(int index) {
        if ((index < 0) || (index >= this._count)) {
            throw new StringIndexOutOfBoundsException(index);
        }
    ...
    public ASCIIByteBuilder replace(int start, int end, String str) {
        if (start < 0) {
            throw new StringIndexOutOfBoundsException(start);
        }
    ...
    public ASCIIByteBuilder insert(int index, byte[] bytes, int offset,
            int len) {
        if ((index < 0) || (index > this._count)) {
            throw new StringIndexOutOfBoundsException(index);
        }
    ...
    public ASCIIByteBuilder insert(int index, char[] str, int offset,
            int len) {
        return insert(index, new String(str).getBytes(), offset, len);
    }

    public ASCIIByteBuilder insert(int offset, Object obj) {
        return insert(offset, String.valueOf(obj));
    }

    public ASCIIByteBuilder insert(int offset, String str) {
        return insert(offset, str.getBytes());
    }

    public ASCIIByteBuilder insert(int offset, byte[] bytes) {
    ...
    public ASCIIByteBuilder insert(int offset, char[] str) {
        return insert(offset, new String(str));
    }

    public ASCIIByteBuilder insert(int dstOffset, CharSequence s,
            int start, int end) {
        if (s == null) {
            return this;
        }
    ...
    public ASCIIByteBuilder insert(int offset, boolean b) {
        return insert(offset, String.valueOf(b));
    }

    public ASCIIByteBuilder insert(int offset, byte b) {
        int newCount = this._count + 1;
        if (newCount > this._value.length) {
            expandCapacity(newCount);
        }
    ...
    public ASCIIByteBuilder insert(int offset, char c) {
        int newCount = this._count + 1;
        if (newCount > this._value.length) {
            expandCapacity(newCount);
        }
    ...
    public ASCIIByteBuilder insert(int offset, int i) {
        return insert(offset, Integer.toString(i));
    }

    public ASCIIByteBuilder insert(int offset, long l) {
        return insert(offset, Long.toString(l));
    }

    public ASCIIByteBuilder insert(int offset, float f) {
        return insert(offset, Float.toString(f));
    }

    public ASCIIByteBuilder insert(int offset, double d) {
