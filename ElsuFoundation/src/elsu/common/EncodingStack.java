 ...
 * modify, update, manipulate strings or arrays for encoding.
 *
...
public class EncodingStack {
    ...
    public static String encode(String data) {
        ...
        for (int i = 0; i < s.length; i++) {
            switch (s[i]) {
                ...
                case '`': // grace accent
                    out.append("%").append(Integer.toHexString((int) s[i]));
                    break;
                default:
                    out.append(s[i]);
                    break;
    ...
    /**
     * decode returns the original url by removing the special notations.
     * Example: %20 = space
     *
     * @param url
     * @return String
        ...
        for (int i = 0; i < s.length; i++) {
            switch (s[i]) {
                case '%': // url encoded value
                    ...
                    out.append((char) Integer.parseInt(sb.toString(), 16));
                    sb.delete(1, 2);
                    break;
                default:
                    out.append(s[i]);
    ...
    public static String b64Decode(String value) {
        org.apache.commons.codec.binary.Base64 base64 = new org.apache.commons.codec.binary.Base64(76, null);
        String out;
    ...
    public static ArrayList<String> csv2Array(String pData, String pDelimiter) {
        ArrayList<String> al = new ArrayList<>();
        String sa[] = pData.split(Pattern.quote(pDelimiter));
    ...
    private static final int[] CRC8_TABLE = {
        ...
        };

    public static int crc8(String value) {
        int crc = 0;
    ...
    public static int crc8(String value, int offset, int length) {
    ...
    public static int crc16(String value, int offset, int length) {
        return crc16(value.substring(offset, length));
    }
    ...
    public static long crc32(String value) {
        ...
        for (int i = 0; i < buffer.length; i++) {
            crc = ((crc >>> 8) ^ CRC32_TABLE[(crc ^ (buffer[i] & 0xFF)) & 0xFF]);
        }

        return ((long) (crc ^ 0xFFFFFFFFL) & 0xFFFFFFFFL);
    }

    public static long crc32(String value, int offset, int length) {
        return crc32(value.substring(offset, length));
    }
    ...
    public static long crc64(String value) {
    ...
    public static long crc64(String value, int offset, int length) {
        return crc32(value.substring(offset, length));
    }
